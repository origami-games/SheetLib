...
import co.origamigames.sheet.block.ClassicLogBlock;
...
public class WoodBlocks {
    ...
    public ClassicLogBlock log;
    public ClassicLogBlock stripped_log;
    ...
    public WoodBlocks(WoodBlocks.Info info) {
        ...
        if (this.boatEntity != null) info.boatItem = Registry.register(Registry.ITEM, new Identifier(this.mod_id, this.wood_id), new TerraformBoatItem(this.boatEntity, new Item.Settings().group(this.item_group).maxCount(1)));

        this.log = (ClassicLogBlock)register(this.wood_id + "_log", info.log);
        this.stripped_log = (ClassicLogBlock)register("stripped_" + this.wood_id + "_log", info.stripped_log);
    ...
    public static class Info {
        ...
        public MaterialColor topMaterialColor = MaterialColor.WOOD;
        public MaterialColor sideMaterialColor = MaterialColor.SPRUCE;
        public MaterialColor sideMaterialColorStripped = MaterialColor.WOOD;
        public SignType signType = SignType.OAK;

        public ClassicLogBlock log = new ClassicLogBlock(topMaterialColor, sideMaterialColor);
        public ClassicLogBlock stripped_log = new ClassicLogBlock(topMaterialColor, sideMaterialColorStripped);
